      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-white text-base">WI Appliance Disposal</span>
            </div>
        ...
        <div className="border-t border-white/10 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-white/50">
            &copy; {new Date().getFullYear()} WI Appliance Disposal. All rights reserved. Based in West Bend, WI.
          </p>
