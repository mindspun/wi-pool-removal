...
export default function Contact() {
  useEffect(() => {
    document.title = "Contact WI Appliance Disposal | Schedule a Pickup";
  }, []);
      ...
      <div className="bg-muted/40 border-b border-border py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            Ready to schedule a pickup or want a quick quote? Reach out — we respond fast.
          </p>
        </div>
      </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            <div className="bg-white border border-border rounded-xl p-8 shadow-sm">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                Use our online request form to describe your job and choose a time. We'll follow up quickly to confirm your appointment and discuss pricing.
              </p>
              <a
              ...
              <p className="text-center text-xs text-muted-foreground mt-3">
                Powered by Jobber — our scheduling platform
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-xl p-8 shadow-sm">
              ...
              <p className="text-muted-foreground leading-relaxed mb-5">
                Prefer to talk? Call or text with your location and what needs to go — we'll give you a price right away and get something on the schedule.
              </p>
              <a
                href="tel:2626990100"
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:2626990100" data-testid="contact-info-phone" className="text-foreground font-semibold hover:text-primary transition-colors">
                      262-699-0100
                    </a>
            ...
            <div className="bg-white border border-border rounded-xl p-6">
              ...
              <ul className="space-y-2.5">
                {[
                  ...
                  "Price confirmed before scheduling",
