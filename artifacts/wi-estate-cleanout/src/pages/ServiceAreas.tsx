...
export default function ServiceAreas() {
  useEffect(() => {
    document.title = "Service Areas | WI Estate Cleanout - Wisconsin Junk Removal";
  }, []);
  ...
  return (
    <Layout>
      <div className="bg-muted/40 border-b border-border py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            WI Estate Cleanout serves five Wisconsin counties from our home base in West Bend. Click a county to see the cities we serve and learn more.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-14">
        <div className="space-y-8">
          {counties.map((county) => (
            <div
              key={county.slug}
              data-testid={`county-section-${county.slug}`}
        ...
        <div className="mt-12 bg-muted/40 border border-border rounded-xl p-6 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            We serve many communities beyond the cities listed here. Call us and ask — chances are we cover your area.
          </p>
          <a
            href="tel:2626990100"
            data-testid="areas-call-button"
      ...
      <CtaBanner
        heading="Serving 5 Wisconsin Counties"
        subtext="Licensed, insured, and donation-first. Call or text for a free estimate."
      />
    </Layout>
  );
}
