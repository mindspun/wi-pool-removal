...
import { Phone, Menu, X, BedDouble, Calendar } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <a
              href="tel:2626990100"
              className="hidden sm:flex items-center gap-1.5 bg-primary text-primary-foreground px-4 py-2 rounded-xl text-sm font-bold hover:bg-primary/90 transition-colors"
            >
            ...
            <a
              ...
              className="hidden md:flex items-center gap-1.5 bg-green-600 text-white px-3 py-2 rounded-xl text-sm font-bold hover:bg-green-700 transition-colors"
            >
        ...
        {open && (
          <div className="md:hidden border-t border-border py-3 space-y-1">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 mx-3 mt-2 px-3 py-2.5 bg-green-600 text-white rounded-xl text-sm font-bold hover:bg-green-700 transition-colors justify-center"
            >
              <Calendar className="w-4 h-4" />
              Schedule Pickup
            </a>
    ...
    <footer className="bg-foreground text-white mt-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-white">WI Mattress Disposal</span>
            </div>
            <p className="text-sm text-white/65 leading-relaxed">
              Locally owned in West Bend, WI. Licensed for solid waste removal. Fully insured. Responsible mattress pickup and disposal throughout southeastern Wisconsin.
            </p>
            <div className="flex flex-wrap items-center gap-3 mt-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 bg-green-600 text-white px-3 py-2 rounded-xl text-sm font-bold hover:bg-green-700 transition-colors"
              >
                <Calendar className="w-4 h-4" />
                Schedule Pickup
              </a>
        ...
        <div className="border-t border-white/10 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-white/40">&copy; {new Date().getFullYear()} WI Mattress Disposal. All rights reserved. West Bend, WI.</p>
