...
export default function Contact() {
  useEffect(() => {
    document.title = "Contact WI Mattress Disposal | Schedule a Pickup";
  }, []);
    ...
    <Layout>
      <div className="bg-gradient-to-br from-muted/60 to-accent/20 border-b border-border py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">Ready to schedule a pickup or get a quick quote? Reach out — we respond fast.</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          <div className="lg:col-span-3 space-y-6">
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">Use our online request form to describe your job and choose a time. We'll follow up quickly to confirm your appointment and discuss pricing.</p>
              <a
                href="https://clienthub.getjobber.com/hubs/70ad09c0-29e5-4b3f-b648-6642ff3dff80/public/requests/4351309/new"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full bg-primary text-primary-foreground font-bold py-3.5 rounded-xl hover:bg-primary/90 transition-colors text-base"
              >
            ...
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              <h2 className="text-xl font-bold text-foreground mb-4">Call or Text Us</h2>
              <p className="text-muted-foreground leading-relaxed mb-5">Tell us your city and how many mattresses — we'll give you a price right away and get something on the schedule.</p>
              <a
                href="tel:2626990100"
                className="flex items-center justify-center gap-2 w-full bg-foreground text-white font-bold py-3.5 rounded-xl hover:bg-foreground/90 transition-colors text-base"
              >
            ...
            <div className="bg-white border border-border rounded-2xl p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground mb-0.5 uppercase tracking-widest font-medium">Phone</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground mb-0.5 uppercase tracking-widest font-medium">Based In</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground mb-0.5 uppercase tracking-widest font-medium">Availability</p>
