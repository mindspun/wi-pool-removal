...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      {/* Hero */}
      <section style={{ background: NAVY }} className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="flex-1 min-w-0">
              ...
              <h1 className="text-4xl sm:text-5xl font-black leading-tight mb-5" style={{ color: '#fff' }}>
                Above Ground Pool Removal in Southeast Wisconsin
              </h1>
              <p className="text-lg mb-3 max-w-xl" style={{ color: "rgba(255,255,255,0.8)" }}>
            ...
            <div className="w-full lg:w-80 xl:w-96 flex-shrink-0">
              <div className="grid grid-cols-2 gap-2">
                <div className="flex flex-col gap-1">
                  <img
                    src={`${import.meta.env.BASE_URL}before.jpeg`}
                    alt="Above ground pool before removal"
                    className="w-full rounded-xl object-cover"
                    style={{ aspectRatio: "4/3" }}
                  />
                  <span className="text-center text-xs font-semibold tracking-widest uppercase" style={{ color: "rgba(255,255,255,0.45)" }}>Before</span>
                </div>
                <div className="flex flex-col gap-1">
                  <img
                    src={`${import.meta.env.BASE_URL}after.jpeg`}
                    alt="Yard after above ground pool removed"
                    className="w-full rounded-xl object-cover"
                    style={{ aspectRatio: "4/3" }}
                  />
                  <span className="text-center text-xs font-semibold tracking-widest uppercase" style={{ color: AQUA }}>After</span>
                </div>
              </div>
              <p className="text-center text-xs mt-2" style={{ color: "rgba(255,255,255,0.35)" }}>Real job — Washington County, WI</p>
            </div>
          </div>
        </div>
      </section>
